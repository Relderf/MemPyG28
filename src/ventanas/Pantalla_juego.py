...
def main(siguiente=False, otros_puntos=0):
    ...
    bottom_window = [
                    [sg.Button('Comenzar', key='comenzar', size=(14,1),
                                font=('Times New Roman', 20), mouseover_colors=verde),
                    sg.Button('Pausar', key='pausar', size=(14,1), mouseover_colors=amarillo,
                              font=('Times New Roman', 20), visible=False)], 
                    [sg.Button('Reiniciar', key = 'reiniciar', mouseover_colors=amarillo,
                               size= (11,1), font=('', 12)), 
                    sg.Button('Salir', key='salir', mouseover_colors=rojo,
                              size= (11,1), font=('', 12))]
                    ]
